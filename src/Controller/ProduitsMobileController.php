...
/*
$alloawedExts = array ["gif","jpeg","jpg","png"];
$temp = explode (".", $_FILES ["file"]["name"]);
$extension = end ($temp);
if ((($_FILES["file"]["type"]=="images/gif")|| ($_FILES["file"]["type"]=="immage/jpeg")||($_FILES["file"]["type"]=="immage/jpg")||($_FILES["file"]["type"]=="immage/png"))){
