...
class getConsole_CommandLoaderService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['console.command_loader'] = new \Symfony\Component\Console\CommandLoader\ContainerCommandLoader(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            ...
            'sonata.user.command.activate_user' => ['privates', '.sonata.user.command.activate_user.lazy', 'get_Sonata_User_Command_ActivateUser_LazyService', true],
            'sonata.user.command.change_password' => ['privates', '.sonata.user.command.change_password.lazy', 'get_Sonata_User_Command_ChangePassword_LazyService', true],
            'sonata.user.command.create_user' => ['privates', '.sonata.user.command.create_user.lazy', 'get_Sonata_User_Command_CreateUser_LazyService', true],
            'sonata.user.command.deactivate_user' => ['privates', '.sonata.user.command.deactivate_user.lazy', 'get_Sonata_User_Command_DeactivateUser_LazyService', true],
            'sonata.user.command.promote_user' => ['privates', '.sonata.user.command.promote_user.lazy', 'get_Sonata_User_Command_PromoteUser_LazyService', true],
            'sonata.user.command.demote_user' => ['privates', '.sonata.user.command.demote_user.lazy', 'get_Sonata_User_Command_DemoteUser_LazyService', true],
            ...
            'sonata.user.command.activate_user' => '?',
            'sonata.user.command.change_password' => '?',
            'sonata.user.command.create_user' => '?',
            'sonata.user.command.deactivate_user' => '?',
            'sonata.user.command.promote_user' => '?',
            'sonata.user.command.demote_user' => '?',
