...
class getSonata_Form_Validator_InlineService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a = ($container->privates['validator.validator_factory'] ?? $container->getValidator_ValidatorFactoryService());

        if (isset($container->privates['sonata.form.validator.inline'])) {
            return $container->privates['sonata.form.validator.inline'];
        }

        return $container->privates['sonata.form.validator.inline'] = new \Sonata\Form\Validator\InlineValidator($container, $a);
    }
}
