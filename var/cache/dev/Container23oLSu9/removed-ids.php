...
return [
    ...
    '.service_locator.Pp3WG_d' => true,
    '.service_locator.QGG8A4p' => true,
    '.service_locator.QJ97Jdn' => true,
    ...
    '.sonata.user.command.activate_user.lazy' => true,
    '.sonata.user.command.change_password.lazy' => true,
    '.sonata.user.command.create_user.lazy' => true,
    '.sonata.user.command.deactivate_user.lazy' => true,
    '.sonata.user.command.demote_user.lazy' => true,
    '.sonata.user.command.promote_user.lazy' => true,
    ...
    'slugger' => true,
    'sonata.doctrine.adapter.doctrine_orm' => true,
    'sonata.doctrine.mapper' => true,
    'sonata.form.date.moment_format_converter' => true,
    'sonata.form.twig.canonicalize_extension' => true,
    'sonata.form.twig.canonicalize_runtime' => true,
    ...
    'sonata.user.command.activate_user' => true,
    'sonata.user.command.change_password' => true,
    'sonata.user.command.create_user' => true,
    'sonata.user.command.deactivate_user' => true,
    'sonata.user.command.demote_user' => true,
    'sonata.user.command.promote_user' => true,
    'sonata.user.form.type.reset_password_request' => true,
    'sonata.user.form.type.resetting' => true,
    'sonata.user.listener.last_login' => true,
    'sonata.user.listener.user' => true,
    'sonata.user.mailer' => true,
    'sonata.user.mailer.default' => true,
    'sonata.user.manager.user' => true,
    'sonata.user.security.user_provider' => true,
    'sonata.user.twig.global' => true,
    'sonata.user.util.canonical_fields_updater' => true,
    'sonata.user.util.token_generator' => true,
    'sonata.user.validator.user_initializer' => true,
