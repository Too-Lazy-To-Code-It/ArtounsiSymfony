 ...
 */
class getLignepanierRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\LignepanierRepository' shared autowired service.
     *
     * @return \App\Repository\LignepanierRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'LignepanierRepository.php';

        return $container->privates['App\\Repository\\LignepanierRepository'] = new \App\Repository\LignepanierRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
