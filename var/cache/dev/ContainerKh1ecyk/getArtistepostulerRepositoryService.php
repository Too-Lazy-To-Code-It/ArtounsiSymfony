 ...
 */
class getArtistepostulerRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ArtistepostulerRepository' shared autowired service.
     *
     * @return \App\Repository\ArtistepostulerRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ArtistepostulerRepository.php';

        return $container->privates['App\\Repository\\ArtistepostulerRepository'] = new \App\Repository\ArtistepostulerRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
