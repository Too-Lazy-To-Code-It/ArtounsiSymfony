 ...
 */
class getBanRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\BanRepository' shared autowired service.
     *
     * @return \App\Repository\BanRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'BanRepository.php';

        return $container->privates['App\\Repository\\BanRepository'] = new \App\Repository\BanRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
