 ...
 */
class getOffretravailarchiveRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\OffretravailarchiveRepository' shared autowired service.
     *
     * @return \App\Repository\OffretravailarchiveRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'OffretravailarchiveRepository.php';

        return $container->privates['App\\Repository\\OffretravailarchiveRepository'] = new \App\Repository\OffretravailarchiveRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
