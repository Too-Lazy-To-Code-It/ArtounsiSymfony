 ...
 */
class getAllusersRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AllusersRepository' shared autowired service.
     *
     * @return \App\Repository\AllusersRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AllusersRepository.php';

        return $container->privates['App\\Repository\\AllusersRepository'] = new \App\Repository\AllusersRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
