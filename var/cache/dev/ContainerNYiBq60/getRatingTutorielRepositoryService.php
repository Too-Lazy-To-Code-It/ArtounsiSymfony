 ...
 */
class getRatingTutorielRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RatingTutorielRepository' shared autowired service.
     *
     * @return \App\Repository\RatingTutorielRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RatingTutorielRepository.php';

        return $container->privates['App\\Repository\\RatingTutorielRepository'] = new \App\Repository\RatingTutorielRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
