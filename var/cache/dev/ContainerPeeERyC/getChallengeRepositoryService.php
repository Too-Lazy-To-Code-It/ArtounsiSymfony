 ...
 */
class getChallengeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ChallengeRepository' shared autowired service.
     *
     * @return \App\Repository\ChallengeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ChallengeRepository.php';

        return $container->privates['App\\Repository\\ChallengeRepository'] = new \App\Repository\ChallengeRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
