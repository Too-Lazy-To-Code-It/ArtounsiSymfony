 ...
 */
class getTutorielRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TutorielRepository' shared autowired service.
     *
     * @return \App\Repository\TutorielRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TutorielRepository.php';

        return $container->privates['App\\Repository\\TutorielRepository'] = new \App\Repository\TutorielRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
