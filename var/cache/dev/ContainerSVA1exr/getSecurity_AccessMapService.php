...
class getSecurity_AccessMapService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a = new \Symfony\Component\HttpFoundation\RequestMatcher('^/Profile');

        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/Admin'), [0 => 'Admin'], NULL);
        $instance->add($a, [0 => 'Observer'], NULL);
        $instance->add($a, [0 => 'Artist'], NULL);
        $instance->add($a, [0 => 'Studio'], NULL);
