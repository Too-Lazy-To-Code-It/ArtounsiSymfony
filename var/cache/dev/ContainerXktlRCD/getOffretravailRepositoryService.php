 ...
 */
class getOffretravailRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\OffretravailRepository' shared autowired service.
     *
     * @return \App\Repository\OffretravailRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'OffretravailRepository.php';

        return $container->privates['App\\Repository\\OffretravailRepository'] = new \App\Repository\OffretravailRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
