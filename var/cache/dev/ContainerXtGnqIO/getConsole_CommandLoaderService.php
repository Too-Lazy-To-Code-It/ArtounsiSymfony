...
class getConsole_CommandLoaderService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['console.command_loader'] = new \Symfony\Component\Console\CommandLoader\ContainerCommandLoader(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            ...
            'jms_translation.command.extract' => ['privates', 'jms_translation.command.extract', 'getJmsTranslation_Command_ExtractService', true],
            'jms_translation.command.list_resources' => ['privates', 'jms_translation.command.list_resources', 'getJmsTranslation_Command_ListResourcesService', true],
            ...
            'maker.auto_command.make_data_provider' => ['privates', '.maker.auto_command.make_data_provider.lazy', 'get_Maker_AutoCommand_MakeDataProvider_LazyService', true],
            'maker.auto_command.make_data_persister' => ['privates', '.maker.auto_command.make_data_persister.lazy', 'get_Maker_AutoCommand_MakeDataPersister_LazyService', true],
