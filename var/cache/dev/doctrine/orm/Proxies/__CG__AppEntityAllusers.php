...
class Allusers extends \App\Entity\Allusers implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function checkCredentials(string $password): bool
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'checkCredentials', [$password]);

        return parent::checkCredentials($password);
    }
     ...
     * {@inheritDoc}
     */
    public function setNumber(string $number): \App\Entity\Allusers
    {
    ...
    public function is2fa(): ?bool
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'is2fa', []);
     ...
     * {@inheritDoc}
     */
    public function set2fa(bool $_2fa): \App\Entity\Allusers
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'set2fa', [$_2fa]);

        return parent::set2fa($_2fa);
    }
