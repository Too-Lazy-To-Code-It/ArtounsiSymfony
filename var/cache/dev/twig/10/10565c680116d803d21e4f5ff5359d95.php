...
class __TwigTemplate_911ff0c264e49d1355f2b687041d498d extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        echo "    <h1>Create new Produits</h1>

    ";
        // line 8
        echo twig_include($this->env, $context, "produits/_form.html.twig");
        echo "
...
{% block title %}New Produits{% endblock %}

{% block body %}
    <h1>Create new Produits</h1>

    {{ include('produits/_form.html.twig') }}

    <a href=\"{{ path('app_produits_index') }}\">back to list</a>
{% endblock %}
", "produits/new.html.twig", "C:\\Users\\achref\\Documents\\ArtounsiSymfony-Achref\\templates\\produits\\new.html.twig");
    }
}
