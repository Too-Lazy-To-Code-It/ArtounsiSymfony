...
class __TwigTemplate_6f13bd064fa130f04636a65073e56e76 extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["produit"]) {
            ...
            echo "            <tr>
                <td>";
            // line 23
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["produit"], "idproduit", [], "any", false, false, false, 23), "html", null, true);
            echo "</td>
                <td>";
            // line 24
            ...
            echo "</td>
                <td>";
            // line 25
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["produit"], "description", [], "any", false, false, false, 25), "html", null, true);
            echo "</td>
                <td>";
            // line 26
            ...
            echo "</td>
                <td>";
            // line 28
            ((twig_get_attribute($this->env, $this->source, $context["produit"], "dateajout", [], "any", false, false, false, 28)) ? (print (twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, $context["produit"], "dateajout", [], "any", false, false, false, 28), "Y-m-d H:i:s"), "html", null, true))) : (print ("")));
            echo "</td>
                <td>
                    <a href=\"";
            // line 30
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_produits_show", ["idproduit" => twig_get_attribute($this->env, $this->source, $context["produit"], "idproduit", [], "any", false, false, false, 30)]), "html", null, true);
            echo "\">show</a>
                    <a href=\"";
            // line 31
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_produits_edit", ["idproduit" => twig_get_attribute($this->env, $this->source, $context["produit"], "idproduit", [], "any", false, false, false, 31)]), "html", null, true);
            echo "\">edit</a>
                </td>
            </tr>
        ";
    ...
    <table class=\"table\">
        ...
        {% for produit in produits %}
            <tr>
                ...
                <td>
                    <a href=\"{{ path('app_produits_show', {'idproduit': produit.idproduit}) }}\">show</a>
...
{% endblock %}
", "produits/index.html.twig", "C:\\Users\\amine\\ArtounsiSymfonyy\\templates\\produits\\index.html.twig");
    }
}
