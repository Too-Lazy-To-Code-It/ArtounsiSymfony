...
<div class=\"currently-market\">
    <div class=\"container\">
                ...
                <div class=\"row grid\">
                    <div>
                        ...
                        <div>
                            ...
                            ";
        // line 168
        if ( !twig_test_empty((isset($context["lignesPanier"]) || array_key_exists("lignesPanier", $context) ? $context["lignesPanier"] : (function () { throw new RuntimeError('Variable "lignesPanier" does not exist.', 168, $this->source); })()))) {
            // line 169
            ...
            $context['_seq'] = twig_ensure_traversable((isset($context["lignesPanier"]) || array_key_exists("lignesPanier", $context) ? $context["lignesPanier"] : (function () { throw new RuntimeError('Variable "lignesPanier" does not exist.', 183, $this->source); })()));
                ...
                echo "                                        <tr>
                                            <td>
                                                <div class=\"left-image\">
                                                    <img src=\"";
                // line 187
                echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(("uploads/images/" . twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["ligne"], "idproduit", [], "any", false, false, false, 187), "image", [], "any", false, false, false, 187))), "html", null, true);
                echo "\"
                                            ...
                                            <td>
                                                <div class=\"right-content\">
                                                    <h6>";
                // line 194
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["ligne"], "idproduit", [], "any", false, false, false, 194), "nom", [], "any", false, false, false, 194), "html", null, true);
                echo "</h6>
                                                </div>
                                            </td>
                                    ...
                                    <span class=\"bid\">
                                      <h6><strong> ";
                // line 200
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["ligne"], "idproduit", [], "any", false, false, false, 200), "prix", [], "any", false, false, false, 200), "html", null, true);
                echo "</strong></h6>
                                    </span>
                                            </td>
                                            ...
                                            <td>
                                                <div class=\"right-content\">
                                                    <h6>";
                // line 207
                echo twig_escape_filter($this->env, (isset($context["tauxTVA"]) || array_key_exists("tauxTVA", $context) ? $context["tauxTVA"] : (function () { throw new RuntimeError('Variable "tauxTVA" does not exist.', 207, $this->source); })()), "html", null, true);
                echo "</h6>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <h6>";
                // line 213
                ((twig_get_attribute($this->env, $this->source, $context["ligne"], "dateajout", [], "any", false, false, false, 213)) ? (print (twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, $context["ligne"], "dateajout", [], "any", false, false, false, 213), "F jS, Y H:i"), "html", null, true))) : (print ("")));
                echo "</h6>
                                            </td>
                                            ";
                // line 215
                if (( !twig_test_empty((isset($context["lignesPanier"]) || array_key_exists("lignesPanier", $context) ? $context["lignesPanier"] : (function () { throw new RuntimeError('Variable "lignesPanier" does not exist.', 215, $this->source); })())) &&  !twig_test_empty(twig_get_attribute($this->env, $this->source, $context["ligne"], "idlignepanier", [], "any", false, false, false, 215)))) {
                    // line 216
                    echo "                                                <td>
                                                    <div class=\"main-button delete-product-button\" data-idlignepanier=\"";
                    // line 217
                    echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["ligne"], "idlignepanier", [], "any", false, false, false, 217), "html", null, true);
                    echo "\">
                                                        <a href=\"";
                    // line 218
                    echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_lignepanier_delete_with_ajax", ["idlignepanier" => twig_get_attribute($this->env, $this->source, $context["ligne"], "idlignepanier", [], "any", false, false, false, 218)]), "html", null, true);
        ...
        // line 245
        echo twig_escape_filter($this->env, (isset($context["count"]) || array_key_exists("count", $context) ? $context["count"] : (function () { throw new RuntimeError('Variable "count" does not exist.', 245, $this->source); })()), "html", null, true);
        echo "</h5></th>
                    <th class=\"count\"><h5>Montant total: ";
        // line 246
        echo twig_escape_filter($this->env, (isset($context["total"]) || array_key_exists("total", $context) ? $context["total"] : (function () { throw new RuntimeError('Variable "total" does not exist.', 246, $this->source); })()), "html", null, true);
        echo "</h5></th>
                    <th>
        ...
        echo "\">Payer</a>
                    ...
                    <th>
                        <div class=\"main-button\">
                            <a href=\"";
        // line 254
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("viderpanier", ["idpanier" => (isset($context["idpanier"]) || array_key_exists("idpanier", $context) ? $context["idpanier"] : (function () { throw new RuntimeError('Variable "idpanier" does not exist.', 254, $this->source); })())]), "html", null, true);
        echo "\">Vider Panier</a>
                        </div>
                    </th>
                </tr>
...
";
    ...
    {
        return array (  553 => 23,  549 => 22,  545 => 21,  541 => 20,  537 => 19,  532 => 16,  522 => 15,  484 => 345,  479 => 343,  474 => 341,  470 => 340,  466 => 339,  461 => 337,  457 => 336,  453 => 335,  402 => 287,  398 => 286,  384 => 275,  380 => 274,  357 => 254,  349 => 249,  343 => 246,  339 => 245,  326 => 234,  319 => 229,  314 => 226,  305 => 222,  298 => 218,  294 => 217,  291 => 216,  289 => 215,  284 => 213,  275 => 207,  265 => 200,  256 => 194,  246 => 187,  241 => 184,  237 => 183,  221 => 169,  219 => 168,  172 => 124,  168 => 123,  68 => 25,  66 => 15,  61 => 13,  52 => 7,  44 => 1,);
    }
