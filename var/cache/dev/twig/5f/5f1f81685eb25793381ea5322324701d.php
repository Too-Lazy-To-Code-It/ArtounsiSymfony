...
class __TwigTemplate_1f859d45228310eb4d459c3c766c28a4 extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"form-group\">
    ...
    <div style=\"color:white;\"> ";
        // line 4
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 4, $this->source); })()), "comment", [], "any", false, false, false, 4), 'errors');
        echo "</div>
</div>
    <button class=\"btn\">";
        // line 6
...
";
    ...
    {
        return array (  61 => 7,  57 => 6,  52 => 4,  48 => 3,  43 => 1,);
    }
...
<div class=\"form-group\">
    {{ form_widget(form) }}
    <div style=\"color:white;\"> {{ form_errors(form.comment) }}</div>
</div>
    <button class=\"btn\">{{ button_label|default('Save') }}</button>
{{ form_end(form) }}
", "comment/_form.html.twig", "C:\\Esprit\\PIDEV\\Codewiljaw\\Symfony\\Artounsi\\templates\\comment\\_form.html.twig");
    }
}
