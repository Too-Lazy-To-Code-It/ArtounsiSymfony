...
class __TwigTemplate_ed41cc4675aca11d13b71378080d0983 extends Template
{
    private $source;
    private $macros = [];
    ...
    color: red;
        ...
        echo "
                                    ...
                                    <div class=\"col-sm-10\">
                                        ";
        // line 60
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 60, $this->source); })()), "niveau", [], "any", false, false, false, 60), 'widget');
        echo "
                                    </div>
                                </div>
