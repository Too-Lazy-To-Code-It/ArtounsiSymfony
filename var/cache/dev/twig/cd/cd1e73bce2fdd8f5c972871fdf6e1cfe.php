...
class __TwigTemplate_aa6b59e7a0e84b9a1f2eedfad2db5705 extends Template
{
    private $source;
    private $macros = [];
    ...
    color: red;
        ...
        echo "
                                    ...
                                    <div class=\"col-sm-10\">
                                        ";
        // line 64
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 64, $this->source); })()), "niveau", [], "any", false, false, false, 64), 'widget');
        echo "
                                    </div>
                                </div>
