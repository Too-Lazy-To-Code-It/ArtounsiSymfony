...
return [
    ...
    'app_lignepanier_delete' => [['idlignepanier'], ['_controller' => 'App\\Controller\\LignepanierController::delete'], [], [['variable', '/', '[^/]++', 'idlignepanier', true], ['text', '/lignepaniersuppProd']], [], [], []],
    ...
    'add_product' => [['idproduit'], ['_controller' => 'App\\Controller\\PanierController::addProduct'], [], [['variable', '/', '[^/]++', 'idproduit', true], ['text', '/panier/panier/add']], [], [], []],
    ...
    'app_produitsBack_index' => [[], ['_controller' => 'App\\Controller\\ProduitsBackController::index'], [], [['text', '/produitsBack/']], [], [], []],
    'app_produitsBack_show' => [['idproduit'], ['_controller' => 'App\\Controller\\ProduitsBackController::show'], [], [['variable', '/', '[^/]++', 'idproduit', true], ['text', '/produitsBack']], [], [], []],
    'app_produits_delete1' => [['idproduit'], ['_controller' => 'App\\Controller\\ProduitsBackController::delete'], [], [['variable', '/', '[^/]++', 'idproduit', true], ['text', '/produitsBack']], [], [], []],
